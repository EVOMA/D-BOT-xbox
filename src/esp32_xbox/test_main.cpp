...
//   log_i("run center 30\% power in half second");
//   xboxController.writeHIDReport(repo);
//   delay(2000);
...
//   log_i("run left 30\% power in half second");
//   xboxController.writeHIDReport(repo);
...
//   repo.v.power.right = 30;
//   log_i("run right 30\% power in half second");
//   xboxController.writeHIDReport(repo);
//   delay(2000);
...
//   log_i("run shake 30\% power in half second");
//   xboxController.writeHIDReport(repo);
//   delay(2000);
...
//   log_i("run center 50\% power in 0.2 sec 3 times");
//   xboxController.writeHIDReport(repo);
//   delay(2000);
// }
